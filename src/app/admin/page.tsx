...
export default async function AdminPage() {
    ...
    return (
        <main className="p-8 text-white bg-[#1c1c1c] min-h-screen">
            ...
            <Link
                href="/admin/new"
                className="inline-block mb-6 bg-gold text-black text-lg px-4 py-2 rounded-md font-medium border border-black/20 shadow-lg hover:bg-yellow-400 transition"
            >
                + Agregar producto
            </Link>
